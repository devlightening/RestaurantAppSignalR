...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20250728092445_mig_add_message_and_appuser_entities_v2")]
    partial class mig_add_message_and_appuser_entities_v2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Basket", b =>
                {
                    ...
                    b.HasOne("SignalR.EntityLayer.Entities.RestaurantTable", "RestaurantTable")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Message", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.AppUser", "ReceiverUser")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SignalR.EntityLayer.Entities.AppUser", "SenderUser")
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Order", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.RestaurantTable", null)
                        .WithMany("Order")
                        .HasForeignKey("RestaurantTableId");
                });
