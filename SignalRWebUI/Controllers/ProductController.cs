...
namespace SignalRWebUI.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            createProductDto.ProductStatus = true; // Default value for new products
            var client = _httpClientFactory.CreateClient();
            var jsonData = JsonConvert.SerializeObject(createProductDto);
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = client.PostAsync("https://localhost:7000/api/Products/", stringContent);
        ...
        public async Task<IActionResult> UpdateProduct(int id)
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:7000/api/Categories");
